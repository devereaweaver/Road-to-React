 ...
 * 
 * Task: Use our React application to fetch data via the Hacker News API. 
 * 
 * In this task we can drop the getAsyncStories() function.
 */
...
// MODULE VARIABLES 
//==============================================================================
const title = "Data Fetching with React";
...
const App = () => {
  ...
  React.useEffect(() => {
    ...
    fetch(`${API_ENDPOINT}javascript&hitsPerPage=100`)
